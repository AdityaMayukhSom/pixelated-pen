import { useAppDispatch } from "devstream/aurelia/hooks";
import { dismissNotification } from "devstream/aurelia/features/notification";
...
export const Notification = ({ notification: { id, type, title, message } }: NotificationProps) => {
